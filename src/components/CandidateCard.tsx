...
export default function CandidateCard({ candidate, index }: Props) {
  ...
  return (
    <motion.div
      ...
      className="bg-card rounded-2xl border border-border p-4 shadow-card hover:shadow-card-hover transition-shadow duration-300 group relative overflow-hidden"
    >
